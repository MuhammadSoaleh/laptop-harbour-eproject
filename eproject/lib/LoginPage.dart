  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:
            Colors.orange, // Set the background color of the AppBar
        foregroundColor:
            Colors.black, // Optional: Set the text and icon color to white
      ),
      body: Stack(
        children: [
          // Background image
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                //         icon: Icon(Icons.add_a_photo_sharp, size: 30),
                //         color: Colors.orange,
                //       ),
                //     ),
                //   ],
                ...
                SizedBox(
                    height:
                        20),
                        Image.asset("assets/WhatsApp_Image_2024-07-26_at_11.12.40_PM-removebg.png",height: 300,width: 300,), // Add space between the image and other widgets if needed
                Text(
                  "LOG IN",
                  style: TextStyle(
                    fontSize: 24,
                ...
                Column(children: [
                  ...
                  Container(
                    ...
                    width: 600,
                    margin:
                        EdgeInsets.fromLTRB(0, 16, 0, 0), // Set the width here
