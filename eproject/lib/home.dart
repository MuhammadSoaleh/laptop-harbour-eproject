  ...
  Widget build(BuildContext context) {
    return Scaffold(
     appBar: AppBar(
        ...
        backgroundColor: Colors.orange, // Set the background color of the AppBar
        foregroundColor: Colors.black, // Optional: Set the text and icon color to white
      ),
      body: Stack(
        children: [
          // Background image
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20), // Add space between the image and other widgets if needed
                Text(
                  "LOG IN",
                  style: TextStyle(
                    fontSize: 24,
